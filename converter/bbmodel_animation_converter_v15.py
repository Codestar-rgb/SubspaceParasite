#!/usr/bin/env python3
"""
BBModelAnimationConverter - Universal Animation Converter (v15)
==============================================================
...
Key Improvements over v14 (5 major fixes):
...
class ConverterConfig:
    ...
    idle_name_extended_aliases: tuple = ('rest', 'breathing', 'ambient', 'pose', 'stand', 'standing',
                                          ...
                                          'waiting', 'still', 'sleep', 'sleeping', 'evolved')
    ...
    walk_dp_epsilon_factor: float = 0.2               # Walk animations use dp_epsilon * this factor (5x less aggressive)
    ...
    evolved_idle_merge_enabled: bool = True             # Enable evolved/idle merging dedup
    evolved_idle_bone_overlap_threshold: float = 0.80   # >80% bone overlap for idle/evolved merge
    evolved_idle_amplitude_correlation_threshold: float = 0.7  # Correlation >0.7 for amplitude patterns
    evolved_keyframe_ratio_threshold: float = 1.5       # If evolved has >=1.5x KFs of idle, prefer evolved
