...
Processes ALL .bbmodel files under the MROLF-TGNBF project directory:
  ...
  2. Converts animation.json using the v19 converter
...
v19 Improvements over v18:
  - PROTECTED-CATEGORY EXACT-DUPLICATE CONSOLIDATION (attack/evolved/idle kept separate)
  - WALK CYCLE EXTENSION FOR TOO-FAST WALKS (0.6667s → 1.35s)
  - WALK MISSING BONE MOTION SYNTHESIS (head/jaw/spine/claw from idle reference)
...
def main():
    ...
    print("  Using v19 Converter with Protected-Category Dedup + Walk Extension + Missing Bone Synthesis")
    print("=" * 70)
    print()
    ...
    # Import v19 converter
    try:
        from bbmodel_animation_converter_v19 import (
            BBModelAnimationConverter,
            ConverterConfig,
        )
        print("  [OK] Loaded bbmodel_animation_converter_v19")
    except ImportError as e:
        print(f"  [FAIL] Could not import v19 converter: {e}")
        sys.exit(1)
    ...
    config = ConverterConfig(
        ...
        evolved_idle_merge_enabled=False,  # v19: DISABLED — protected categories should not be merged
        # =============================================
        ...
        # =============================================
        # v19 NEW: Protected-Category Dedup
        # =============================================
        protected_category_consolidation=True,
        # v19 NEW: Walk Cycle Extension
        walk_cycle_extension_enabled=True,
        walk_min_natural_duration=0.8,
        walk_extension_target_duration=1.3334,
        # v19 NEW: Walk Missing Bone Synthesis
        walk_missing_bone_synthesis=True,
    )
    ...
    print()
    print("=" * 70)
    print("  BATCH CONVERSION SUMMARY (v19)")
    print("=" * 70)
    ...
    print()
    print(f"  --- v16/v17/v18/v19 Improvements ---")
    ...
    print()
    print("=" * 70)
    print("  DONE - Batch Convert All (v19)")
