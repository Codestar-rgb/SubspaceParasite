#!/usr/bin/env python3
"""
BBModelAnimationConverter - Universal Animation Converter (v10)
==============================================================
...
Key Improvements over v9 (6 major improvements):
...
class ConverterConfig:
    """Master configuration for BBModelAnimationConverter v10."""
    # --- Loop Detection ---
...
class BBModelAnimationConverter:
    ...
    def convert_file(self, bbmodel_path: str,
        ...
        for anim_name, anim_data in extracted['animations'].items():
            ...
            # Step 11b [v10 NEW]: Loop Validation Pass
    ...
    def _deep_idle_dedup(
        ...
        """v10 Improvement 2: Aggressive Deep Idle Deduplication.

        Beyond v9's near-duplicate removal, adds:
        - Extended idle name aliases for broader detection
        - Lower amplitude similarity threshold for more aggressive dedup
    ...
    def _loop_validation_pass(
        ...
        """v10 Improvement 6: Secondary Loop Validation Pass.
        ...
        # Apply a final C0 snap: ensure last keyframe matches first
        result_channels = {}
        for bone_name, channels in bone_channels.items():
            result_channels[bone_name] = {}
            for channel, keyframes in channels.items():
                ...
                if c0_err > 0.001:
                    ...
                    # Use a quadratic blend over the last 3 keyframes
                    if len(new_kfs) >= 4:
    ...
    def _post_process_empty_cleanup(
        ...
        """v10 Improvement 4: Post-Process Empty Animation File Cleanup.

        After conversion, checks if the output file is truly empty or contains
        only meaningless data, and removes it if so. Also consolidates
        single-clip animation files.
        """
        cfg = self.config
...
def batch_convert(input_dir: str, output_dir: str,
    ...
    """Batch convert all .bbmodel files in a directory tree (v10).

    For each .bbmodel file:
      - Extract geo.json + texture (using bbmodel_to_geo.py)
      - Extract and convert animations (using this v10 converter)
    ...
    """
    print("=" * 70)
    print("  Universal BBModel Animation Converter (v10)")
    print("  .bbmodel -> .animation.json with C1+C2 Correction & v10 Improvements")
    ...
    print()
    print("=" * 70)
    print("  DONE - Universal BBModel Animation Converter (v10)")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Universal BBModel Animation Converter with C1+C2 Correction & v10 Improvements"
    )
