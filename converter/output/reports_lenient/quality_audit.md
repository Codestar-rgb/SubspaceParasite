...
**Timestamp:** 2026-06-05T17:42:34.929402+00:00
**Threshold Mode:** lenient
**Total Models:** 2
**Total Animations:** 9
...
|-----------|--------------|-------------|--------------------|---------------------|
| Mean | 61.34 | 0.7773 | 20.3551 | 47.4320 |
...
1. **heblu/animation.model.fly**: C1 error 127.74 deg/s is >3x threshold (15.00)
2. **heblu/animation.model.cosmic**: C1 error 75.13 deg/s is >3x threshold (15.00)
3. **heblu/animation.model.idle**: C1 error 69.84 deg/s is >3x threshold (15.00)
4. **heblu/animation.model.attack**: C1 error 53.60 deg/s is >3x threshold (15.00)
5. **heblu/animation.model.shaking**: C1 error 50.43 deg/s is >3x threshold (15.00)
6. **heblu/animation.model.cosmic_shaking**: C1 error 49.04 deg/s is >3x threshold (15.00)
...
| 7 | kirin/animation.srparasites.kirin.idle | 62.8 | D | 14.7671 | 1.1002 | 0.5111 | 1.0000 |
...
- **Average naturalness:** 0.7773
- **Below threshold (0.6):** 1 animations
