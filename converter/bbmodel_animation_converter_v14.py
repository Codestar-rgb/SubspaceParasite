#!/usr/bin/env python3
"""
BBModelAnimationConverter - Universal Animation Converter (v14)
==============================================================
...
Key Improvements over v13 (6 major improvements):
    ...
    def convert_file(self, bbmodel_path: str,
        ...
        for anim_name, anim_data in extracted['animations'].items():
            ...
            if loop_mode == "loop":
                ...
                # v14: Use multi-pass C1 enforcement for better C1 continuity
                if getattr(self.config, 'c1_multipass_enabled', False):
